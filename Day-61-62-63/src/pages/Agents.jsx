  ...
  useGSAP(function () {
    gsap.to(imageDivRef.current, {
      scrollTrigger: {
        ...
        // scrub: true,
        onUpdate:(elem)=>{
          // console.log(Math.round(elem.progress*images.length));
          let imgIndex;
          if(elem.progress<1){
            imgIndex=Math.round(elem.progress*images.length);
          }else{
            imgIndex=images.length-1;
          }
          imgRef.current.src=images[imgIndex];
  ...
  return (
    <div>
      <div className="section1 py-1">
        <div
          ref={imageDivRef}
          className="h-[20vw] overflow-hidden rounded-3xl w-[15vw] top-55 absolute left-[30vw] "
        >
          <img
            ref={imgRef}
        ...
        <div className="relative font-[font2]">
          ...
          <div className="font-[font1] pl-[39%] mt-10">
            <p className=" text-[4vw] leading-[3.5vw] mr-2 ">
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
